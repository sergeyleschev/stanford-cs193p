...
//  Set Card
//
//  Created by Sergey Leschev on 8.08.20.
...
class CardView: UIView {
    ...
    enum Shape { case squiggle, oval, diamond }
    enum Fill { case empty, striped, solid }
...
extension CardView {
    ...
    private var faceRect: CGRect { bounds.zoom(by: 0.70) }
    private var cornerRadius: CGFloat { bounds.size.height * SizeRatio.cornerRadiusToBoundsHeight }
    private var shapeRectHeight: CGFloat { faceRect.size.height * SizeRatio.shapeRectHeightToFaceRectHeight }
    private var interShapesGap: CGFloat { shapeRectHeight * SizeRatio.gapHeightToShapeRectHeight }
    private var shapeRectOffcet: CGFloat { shapeRectHeight + interShapesGap }
}
