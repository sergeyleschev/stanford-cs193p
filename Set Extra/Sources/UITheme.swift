...
//  Set
//
//  Created by Sergey Leschev on 17.07.20.
...
struct Theme {
    ...
    static let cardColorSelected: UIColor = #colorLiteral(red: 0.6000000238, green: 0.6000000238, blue: 0.6000000238, alpha: 1)
    static let cardColorMatched: UIColor = #colorLiteral(red: 0.9568627477, green: 0.6588235497, blue: 0.5450980663, alpha: 1)
